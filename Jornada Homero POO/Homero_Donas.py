...
while running:
    ...
    pygame.draw.rect(screen, "blue", mi_homero.rectangulo, 3)
    pygame.draw.rect(screen, "green", mi_homero.rect_boca, 3)
    
    for d in lista_donas:
        pygame.draw.rect(screen, "orange", d.rectangulo, 3)
